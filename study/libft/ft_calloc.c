...
// 		printf("ft_arr[%zu] = %d\n", i, std_arr[i]);
// 	free(ft_arr);
// 	free(std_arr); de nmemb elementos, cada elemento tem size bytes
//e garante que toda essa memoria esteja zerada, zera todos os bytes alocados
// #include "libft.h"
...
// 	// nmemb * size . SIZE_MAX, entao dara OVERFLOW!
// 		//SIZE_MAX 'e o maior valor possivel pra size_t (definido em limits.h)
